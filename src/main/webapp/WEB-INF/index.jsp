...
<body>
    <div id="wrapper">
        <nav class="navbar-default navbar-static-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav metismenu" id="side-menu">
                    ...
                    <li>
                        <a href="index.html#"><i class="fa fa-desktop"></i> <span class="nav-label">App Views</span>  <span class="float-right label label-primary">SPECIAL</span></a>
                        <ul class="nav nav-second-level collapse">
                    ...
                    <li>
                        <a href="index.html#"><i class="fa fa-globe"></i> <span class="nav-label">Miscellaneous</span><span class="label label-info float-right">NEW</span></a>
                        <ul class="nav nav-second-level collapse">
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level collapse">
                            <li>
                                <a href="index.html#" id="damian">Third Level <span class="fa arrow"></span></a>
                                ...
                                <div class="ibox-title">
                                    ...
                                    <div class="ibox-tools">
                                        ...
                                        <ul class="dropdown-menu dropdown-user">
                                            <li><a href="index.html#" class="dropdown-item">Config option 1</a>
                                            </li>
                                            <li><a href="index.html#" class="dropdown-item">Config option 2</a>
                                            </li>
                                        </ul>
                                            ...
                                            <div class="feed-activity-list">
                                                ...
                                                <div class="feed-element">
                                                    ...
                                                    <div class="media-body ">
                                                        ...
                                                        <small class="text-muted">Yesterday 1:21 pm - 11.06.2014</small>
                                                        <div class="actions">
                                                            <a href="index.html"  class="btn btn-xs btn-white"><i class="fa fa-thumbs-up"></i> Like </a>
                                                            <a href="index.html"  class="btn btn-xs btn-white"><i class="fa fa-heart"></i> Love</a>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="feed-element">
        ...
        <div id="small-chat">
            ...
            <a class="open-small-chat" href="index.html">
                <i class="fa fa-comments"></i>
        ...
        <div id="right-sidebar" class="animated">
            <div class="sidebar-container">
                ...
                <ul class="nav nav-tabs navs-3">
                    <li>
                        <a class="nav-link active" data-toggle="tab" href="index.html#tab-1"> Notes </a>
                    </li>
                    <li>
                        <a class="nav-link" data-toggle="tab" href="index.html#tab-2"> Projects </a>
                    </li>
                    <li>
                        <a class="nav-link" data-toggle="tab" href="index.html#tab-3"> <i class="fa fa-gear"></i> </a>
                    </li>
                </ul>
